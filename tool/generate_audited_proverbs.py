...
audit_data = {
    ...
    "43": {"fa": "زبان سرخ سر سبز را می‌دهد بر باد.", "class": "EXACT SCRIPT RENDERING", "notes": "Canonical proverb for 43/44 group.", "variants": ["44"]},
    ...
    "70": {"fa": "کار کار کاردان است.", "class": "EXACT SCRIPT RENDERING", "notes": "Canonical proverb for 70/149 group.", "variants": ["149"]},
    ...
    "96": {"fa": "دوست را در روز سخت شناسند.", "class": "EXACT SCRIPT RENDERING", "notes": "Canonical proverb for 96/170 group.", "variants": ["170"]},
    "97": {"fa": "دوست نادان از دشمن دانا بدتر است.", "class": "EXACT SCRIPT RENDERING", "notes": "Exact 1:1 transcription.", "canonicalId": "98"},
    "98": {"fa": "دشمن دانا به از دوست نادان.", "class": "FAITHFUL TRANSLATION", "notes": "Restored classical proverb form.", "variants": ["97"]},
    ...
    "120": {"fa": "درخت پربار سر خم می‌کند.", "class": "EXACT SCRIPT RENDERING", "notes": "Canonical proverb for 120/166 group.", "variants": ["166"]},
    ...
    "168": {"fa": "چاه کس را مکن، که خود می‌افتی.", "class": "EXACT SCRIPT RENDERING", "notes": "Canonical proverb for 112/168 group.", "variants": ["112"]},
    "169": {"fa": "هر چه کشتی، همان دروی.", "class": "FAITHFUL TRANSLATION", "notes": "Canonical proverb for 71/169 group. Prior used 'هر چه بکاری، همان را درو می‌کنی'; restored authentic meter.", "variants": ["71"]},
