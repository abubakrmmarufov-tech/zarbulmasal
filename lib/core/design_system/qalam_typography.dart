...
class QalamTypography {
  ...
  static TextStyle pageTitle({required Color color, double fontSize = 40}) =>
      sectionTitle(
        color: color,
        fontSize: fontSize,
        fontWeight: FontWeight.w700,
      ).copyWith(letterSpacing: -1.6, height: 1.08);
  ...
  static TextStyle eyebrow({required Color color, double fontSize = 11}) =>
      label(color: color, fontSize: fontSize).copyWith(letterSpacing: 0.7);
  static TextStyle navLabel({required Color color, double fontSize = 10}) =>
